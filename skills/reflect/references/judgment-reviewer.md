...
- `Read` tool calls against any `SKILL.md` file in host skill roots, such as `${CODEX_HOME:-$HOME/.codex}/skills/`, `~/.claude/skills/`, project `.claude/skills/`, workspace skill directories, or installed plugin skill paths
