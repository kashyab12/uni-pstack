...
Launch one reviewer per model in your configured interrogate list (defaults `gpt-5.6-sol high reasoning`, `gpt-5.6-sol high reasoning`, `gpt-5.6-sol high reasoning`), all concurrently.
