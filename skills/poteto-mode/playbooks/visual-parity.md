...
4. Verify each component against its baseline via image diff on the matching surface through the host control tool. A nonzero diff is a fail; investigate the pixel delta, don't wave it through. Iterate per component until the diff is zero.
