...
- Use Fable 5 high only for explicit Claude-only workers. For Claude-only UI or UX judgment, use Fable 5 high for hard calls and medium for cheaper iteration.
