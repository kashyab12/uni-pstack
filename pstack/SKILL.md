...
- Codex delegation default: `gpt-5.6-sol`, high reasoning, and the supported fast/priority tier. This replaces upstream pstack's Composer/Claude Opus model defaults.
