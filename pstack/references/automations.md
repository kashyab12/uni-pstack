...
- Execution: `codex exec` with `gpt-5.6-sol`, high reasoning for the automation coordinator, and supported fast/priority tier unless overridden. Delegated routine workers and explorers use medium.
